...
public class Example02 {
    ...
    public static void main(String[] args) {
        ...
        sort(objects, new Comparator<Person>() { // Создание анонимного объекта который реализует метод compare класса Comparator
            @Override
...
class PersonObjectByWeightComparator implements Comparator<Person> {
    @Override
    public int compare(Person o1, Person o2) {
